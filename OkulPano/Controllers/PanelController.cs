...
namespace OkulPano.Controllers
{
    public class PanelController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.que = queue;
            string[,] PanoModel = new string[13, 2]
            {
                {"Bahçe","Ahmet Öğretmen" },
                {"Giriş Kat","Mahmut Öğretmen" },
                {"1.Kat","Şule Öğretmen" },
                {"2.Kat","Ayhan Öğretmen" },
                {"3.Kat","Hayriye Öğretmen" },
                {"4.Kat","Canan Öğretmen" },
                {"5.Kat","Meryem Öğretmen" },
                {"6.Kat","Kadir Öğretmen" },
                {"7.Kat","Aslı Öğretmen" },
                {"8.Kat","Metin Öğretmen" },
                {"9.Kat","Süleyman Öğretmen" },
                {"10.Kat","Tanju Öğretmen" },
                {"Kantin","Cevriye Öğretmen" }
            };
            ViewBag.Nöbet = PanoModel;
